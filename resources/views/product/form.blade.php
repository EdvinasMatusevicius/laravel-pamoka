            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    @if(isset($product->id))
                        ...
                        @endif
                     Product</div>
                    <form action="{{ route('products.'.(isset($product->id) ? 'update' : 'store'), isset($product->id) ? ['product' => $product->id] : [] ) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @isset($product->id)
                            @method('put')
                        @endisset
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" type="text" name="title" id="title" value="{{ old('title',$product->title ?? '') }}">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('slug') is-invalid @enderror" type="text" name="slug" id="slug" value="{{ old('slug',$product->slug ?? '') }}">
                                @error('slug')
                                <div class="alert-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('price') is-invalid @enderror" type="number" name="price" id="price" value="{{ old('price',$product->price  ?? 0.01) }}" min="0.01" step="0.01">
                                @error('price')
                                <div class="alert-danger">
                                    {{ $message }}
                                </div>
